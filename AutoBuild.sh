...
cp -r /mnt/hgfs/Share/code/edk2_code/MdeModulePkg/Application/A  MdeModulePkg/Application/
...
cp ./Build/EmulatorX64/DEBUG_GCC5/X64/A.efi /mnt/hgfs/Share/code/output/A.efi
